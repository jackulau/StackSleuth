import { RedisAgent, RedisOperationMetrics, RedisPerformanceStats } from '../index';

describe('RedisAgent', () => {
  let agent: RedisAgent;
  ...
  describe('constructor', () => {
    it('should create a new RedisAgent instance', () => {
      expect(agent).toBeInstanceOf(RedisAgent);
    });

    it('should accept configuration options', () => {
      const configuredAgent = new RedisAgent({
        slowQueryThreshold: 50,
        maxMetricsHistory: 500,
        autoInit: false
      });
      expect(configuredAgent).toBeInstanceOf(RedisAgent);
    });
  });
  ...
  describe('recordOperationMetrics', () => {
    ...
    it('should record slow query metrics', () => {
      const slowMetrics: RedisOperationMetrics = {
        command: 'SCAN',
    ...
    it('should record error metrics', () => {
      const errorMetrics: RedisOperationMetrics = {
        command: 'SET',
        duration: 5,
        keyCount: 1,
        dataSize: 50,
