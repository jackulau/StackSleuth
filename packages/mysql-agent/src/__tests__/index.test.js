...
describe('MySQLAgent', () => {
    ...
    describe('constructor', () => {
        it('should create a new MySQLAgent instance', () => {
            expect(agent).toBeInstanceOf(index_1.MySQLAgent);
        });
        it('should accept configuration options', () => {
            const configuredAgent = new index_1.MySQLAgent({
                slowQueryThreshold: 50,
                maxMetricsHistory: 500,
                autoInit: false
            });
            expect(configuredAgent).toBeInstanceOf(index_1.MySQLAgent);
        });
    });
    describe('init', () => {
...
describe('createMySQLAgent', () => {
    it('should create a new MySQLAgent instance', () => {
        const agent = (0, index_1.createMySQLAgent)({ autoInit: false });
        expect(agent).toBeInstanceOf(index_1.MySQLAgent);
    });
    it('should pass configuration to the agent', () => {
        const agent = (0, index_1.createMySQLAgent)({
